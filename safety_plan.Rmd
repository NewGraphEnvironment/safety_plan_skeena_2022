...
A zip file which includes kml (google earth) and gpx (garmin) files of the sites to be potentially assessed can be downloaded [here](%60r%20knitr::asis_output(link_kml)%60). Georeferenced pdf maps can be accessed and downloaded [here for Bulkley and Morice](%60r%20knitr::asis_output(link_fieldmaps)%60), [here for Kispiox](%60r%20knitr::asis_output(link_fieldmaps2)%60) and [here for the Copper](%60r%20knitr::asis_output(link_fieldmaps3)%60).
