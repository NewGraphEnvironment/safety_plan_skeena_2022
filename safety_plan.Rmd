...
A zip file which includes kml (google earth) and gpx (garmin) files of the sites to be potentially assessed can be downloaded [here](`r knitr::asis_output(link_kml)`). Georeferenced pdf maps can be accessed and downloaded [here for Bulkley and Morice](`r knitr::asis_output(link_fieldmaps)`), [here for Kispiox](`r knitr::asis_output(link_fieldmaps2)`) and [here for the Copper](`r knitr::asis_output(link_fieldmaps3)`).
...
The write ups for the past couple of years of fieldwork assessments are [here](https://newgraphenvironment.github.io/fish_passage_bulkley_2020_reporting/) for 2020 and [here](https://newgraphenvironment.github.io/fish_passage_skeena_2021_reporting/) for 2021.  Still picking away at 2021 and just updating version IDs as I get through it.
